...
> This article is the first of a series of articles where I will be explaining this crazy topic:
>
> - Theory behind Pulse-Width Modulation (PWM) (current article).
> - Build a simple circuit with [RPIO](https://www.npmjs.com/package/rpio) using Hardware-based PWM (Soon: Hardware-based PWM with RPIO).
> - Build a simple circuit using [PIGPIO](https://www.npmjs.com/package/pigpio) using Sofware-based PWM (Soon: Software-based PWM with RPIO).
...
![Forward current vs. applied voltage](/assets/blog/2021-05-22/LED_Chart01.png)
...
![Forward current vs. Luminous intensity](/assets/blog/2021-05-22/LED_Chart02.png)
...
![Simple Circuit](/assets/blog/2021-05-22/PWM_01.png)
...
<p style="text-align:center;">
    <video src="/assets/blog/2021-05-22/PWM_01.mov" style="max-width: 100%;" autoplay controls loop></video>
</p>
...
![Voltage, current, and resistance](/assets/blog/2021-05-22/V-I-R.jpg)
...
<p style="text-align:center;">
    <video src="/assets/blog/2021-05-22/PWM_02.mov" style="max-width: 100%;" autoplay controls loop></video>
</p>
